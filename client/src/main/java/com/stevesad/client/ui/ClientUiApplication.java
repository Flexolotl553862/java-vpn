...
public class ClientUiApplication extends Application {
    ...
    public void start(Stage stage) {
        ...
        ClientLauncher clientLauncher = applicationContext.getBean(ClientLauncher.class);

        mainView = new ClientMainView(stage, localStorage, clientLauncher);
        ...
        Platform.runLater(() -> {
            mainView.loadProfiles();
            mainView.loadTrustCerts();
        });
    }
